...
export default defineConfig({
  entry: {
    ...
    "lib/reminders": "src/lib/reminders.ts",
    "mcp/tools/create-reminder": "src/mcp/tools/create-reminder.ts",
    "mcp/tools/list-reminders": "src/mcp/tools/list-reminders.ts",
    "mcp/tools/complete-reminder": "src/mcp/tools/complete-reminder.ts",
  },
  format: ["esm"],
  target: "node18",
  platform: "node",
